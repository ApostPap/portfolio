...
class Contact extends React.Component {
  ...
  componentDidMount() {
    ...
    ReactGa.initialize("");
    ReactGa.pageview('Portfolio - Contact Screen');
  }
  ...
  render() {
    return (
      <div>
        <Helmet>
                <meta charSet="utf-8" />
                <title>Contact | Apostolos Papadopoulos</title>
                <link rel="canonical" href="" />
                <meta name="description" content="Apostolos Papadopoulos | Contact - Software Developer  | Software Developer  | Software Engineer | Tech Enthusiast"/>
        </Helmet>

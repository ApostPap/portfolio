...
class Projects extends Component {
  ...
  componentDidMount() {
    ...
    ReactGa.initialize("");
    ReactGa.pageview('Portfolio - Projects');
  ...
  render() {
    return (
        <Container className="About-header" fluid={true}>
          <Helmet>
                <meta charSet="utf-8" />
                <title>Projects | Apostolos Papadopoulos</title>
                <link rel="canonical" href="" />
                <meta name="description" content="Apostolos Papadopoulos | Projects - Product Manager | Project Manager | Software Engineer
